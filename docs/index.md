...
<div class="hero">
  <img src="{{ site.baseurl }}/assets/images/avatar.jpg" alt="Dr Rashidatu Abdulazeez" style="width:160px; border-radius:50%; float:right; margin-left:20px; margin-bottom:20px;">
